  ...
  return (
    <section id="about" className="section-padding bg-white relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, #C49A3C, transparent)', borderRadius: '60% 40% 55% 45%' }}
      />
      <div
        className="absolute bottom-0 left-0 w-80 h-80 opacity-5 translate-y-1/2 -translate-x-1/2"
        style={{ background: 'radial-gradient(circle, #2C3E6B, transparent)', borderRadius: '40% 60% 45% 55%' }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative mx-auto max-w-[440px]">
              ...
              >
                ...
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, rgba(196, 154, 60, 0.15), transparent 60%)' }}
                />
              </div>

              {/* Inset frame line — echoes the arch, sits just inside the edge */}
              <div
                className="absolute inset-3 pointer-events-none border border-white/50"
                style={{ borderRadius: '200px 200px 8px 8px' }}
              />
            </div>
          ...
          <div className="reveal-right">
            ...
            <p className="text-sunset-purple/70 text-lg leading-relaxed mb-6">
              Nestled where the sky meets the sea, NAGAS Resort was born from a dream — to create a place where luxury and nature exist in perfect harmony. We have been crafting moments that last a lifetime.
            </p>
